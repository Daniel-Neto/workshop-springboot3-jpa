...
public class Product implements Serializable{
	...
	@OneToMany(mappedBy = "id.product") // 1 Product pode possuir vários OrderItem. 1 - N
	...
	// Estou pegando a coleção de Orders relacionada a um produto. Retorna uma lista de Orders
	@JsonIgnore
