...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// salvas os objetos Product e Category
		...
		// salva os objetos Product após associar as categories aos produtos
		// Isso vai gerar uma association table ao salvar
		productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5));
		
		// Cria objetos user no banco
